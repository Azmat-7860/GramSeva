  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.count}>{collectors.length} total</Text>
      </View>

      <ScrollView contentContainerStyle={styles.scrollContent}>
        {collectors.map((c, i) => (
          <Animated.View key={c.id} entering={FadeInUp.delay(i * 30).duration(300)}>
            <TouchableOpacity style={styles.collectorRow}>
              ...
              <Badge
                label={c.pin_hash ? 'PIN Set' : 'No PIN'}
      ...
      <Modal visible={modalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Input label="Name" placeholder="Collector name" value={name} onChangeText={setName} />
